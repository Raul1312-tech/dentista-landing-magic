        ...
        <section id="servicios" className="section-padding">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <div className="inline-block bg-primary/10 text-primary font-medium text-sm px-4 py-1 rounded-full mb-4 animate-on-scroll">
                Nuestros Servicios
              </div>
              <h2 className="heading-lg mb-4 animate-on-scroll highlight-gradient">Soluciones Especializadas para Clínicas Dentales</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <div className="glass-card p-6 rounded-2xl animate-on-scroll tech-border transform hover:scale-105 transition-all duration-300 group">
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground">Campañas en Redes Sociales</h3>
              ...
              <div className="glass-card p-6 rounded-2xl animate-on-scroll tech-border transform hover:scale-105 transition-all duration-300 group" style={{ animationDelay: '0.2s' }}>
                <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground">Community Manager</h3>
                <p className="text-muted-foreground mb-4">
              ...
              <div className="glass-card p-6 rounded-2xl animate-on-scroll tech-border transform hover:scale-105 transition-all duration-300 group" style={{ animationDelay: '0.4s' }}>
                <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground">SEO y Posicionamiento</h3>
                <p className="text-muted-foreground mb-4">
              ...
              <div className="glass-card p-6 rounded-2xl animate-on-scroll tech-border transform hover:scale-105 transition-all duration-300 group" style={{ animationDelay: '0.6s' }}>
                <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary">
                ...
                <h3 className="text-xl font-bold mb-3 text-foreground">Protocolos de Venta</h3>
                <p className="text-muted-foreground mb-4">
